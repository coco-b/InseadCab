...
class PeopleController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $people = $em->getRepository('CabBundle:People')->findAll();
    ...
    {
        $person = new Person();
        $form = $this->createForm('CabBundle\Form\PeopleType', $person);
    ...
    {
        $deleteForm = $this->createDeleteForm($person);
        $editForm = $this->createForm('CabBundle\Form\PeopleType', $person);
